...
export const reflections: Reflection[] = [
  {
    ...
    excerpt: 'A five-part series exploring what ancient Indian philosophy — Nyaya Darshan, the Vedas, and Vedic epistemology — has to teach modern designers about process, knowledge, and intention.',
    url: 'https://medium.com/@amitkrt/how-vedic-secrets-can-disrupt-your-design-game-1-286b6cee79d6',
    image: '/images/reflections/Vedic Secrets.webp',
  },
  {
    id: 'ai-genai-framework',
    category: 'AI & Humanity',
    title: 'Is There Any Framework for Designing AI and Gen-AI Experiences?',
    excerpt: 'AI is dominating design conversations everywhere — but the tools, principles, and mental models for designing it responsibly are still catching up. A working framework for practitioners.',
    url: 'https://medium.com/@amitkrt/is-there-any-framework-for-designing-ai-and-gen-ai-experiences-4f9924319b0d',
    image: '/images/reflections/Framework for AI:Gen AI.webp',
  },
  {
    id: 'conversational-ux',
    category: 'AI & Humanity',
    title: 'The Future of UX is Conversational',
    excerpt: 'Conversational experiences are becoming the go-to for information access and complex tasks. But measuring their success requires entirely different thinking than traditional UX metrics.',
    url: 'https://medium.com/@amitkrt/the-future-of-ux-is-conversational-heres-how-to-measure-its-success-e67d0651638f',
    image: '/images/reflections/FutureofUX.webp',
  },
  {
  ...
  },
  {
    ...
    excerpt: '"What is design?" — a question that surfaces constantly, and whose answer keeps shifting. A reflection on how the definition of design expands with every decade of practice.',
    url: 'https://medium.com/@amitkrt/ever-evolving-design-9ea1faffe5c3',
    image: '/images/reflections/Ever-evolvingDesign.webp',
  },
  {
    id: 'design-trends-2025',
    category: 'Future of Design',
    title: '2025 Design Trends Every UX Designer Needs to Know',
    excerpt: 'Game-changing, fresh, and inevitable shifts that will define the design landscape in 2025 and beyond — from agentic interfaces to the collapse of the screen as primary canvas.',
